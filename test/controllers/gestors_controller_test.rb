...
class GestorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gestor" do
    assert_difference("Gestor.count") do
      post gestors_url, params: { gestor: { descripcion: @gestor.descripcion, estado: @gestor.estado, fecha_inicio: @gestor.fecha_inicio, fecha_termino: @gestor.fecha_termino, nombre: @gestor.nombre } }
    end
  ...
  test "should update gestor" do
    patch gestor_url(@gestor), params: { gestor: { descripcion: @gestor.descripcion, estado: @gestor.estado, fecha_inicio: @gestor.fecha_inicio, fecha_termino: @gestor.fecha_termino, nombre: @gestor.nombre } }
